...
<div class="wrapper">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT nombreDes, descripcionproducto, fecha_elaboracion, fecha_caducidad, cantidad FROM analgesiosperros WHERE nombreDes = '$nombreDes_buscar'";
        ...
        if ($query) {
            if (mysqli_num_rows($query) > 0) {
                ...
                while ($row = mysqli_fetch_array($query)) {
                    ...
                    echo "<td><a href='eliminarANALGESICOperro.php?nombreDes=" . $row['nombreDes'] . "' class='btn btn-danger'><i class='fas fa-trash'></i></a>
      <a href='actualizarAnalgesicosperros.php?nombreDes=" . $row['nombreDes'] . "' class='btn btn-info'><i class='fas fa-edit'></i></a></td>";
echo "</tr>";
    ...
    mysqli_close($con);
    ?>
     <a href="M_analgesicos.php" class="regresar">Regresar</a>
</div>
