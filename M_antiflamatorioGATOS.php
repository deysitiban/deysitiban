...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO antifflamatoriosgatos (nombreDes,descripcionproducto, fecha_elaboracion, fecha_caducidad, cantidad) VALUES ('$nombreDes', '$descripcionproducto', '$fecha_elaboracion', '$fecha_caducidad', '$cantidad')";
    mysqli_query($con, $sql);

    header("Location: M_antiflamatorioGATOS.php");
    exit();
}
...
<div class="tablas">
<div class="busqueda">
<form action="BUSCARantiflamatorioGATOS.php" method="post">
<label for="nombreDes"><i class="fas fa-search"></i></label>
    ...
    <input type="submit" class="boton" value="Buscar">
       ...
       <h1 class="des">ANTIFLAMATORIO</h1>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    $sql = "SELECT nombreDes, descripcionproducto,fecha_elaboracion, fecha_caducidad, cantidad FROM antifflamatoriosgatos ORDER BY fecha_caducidad DESC";
                    ...
                    if ($rta) {
                        while ($row = mysqli_fetch_array($rta)) {
                            ...
                            $opciones = "<td><a href='ELIMINARantiflamatorioGATOS.php?nombreDes=" . $row['nombreDes'] . "' class='btn btn-danger'><i class='fas fa-trash'></i> </a>  ";
                            $opciones .= "<a href='ACTUALIZARantiflamatorioGATOS.php?nombreDes=" . $row['nombreDes'] . "' class='btn btn-danger'><i class='fas fa-edit'></i> </a></td>";
