...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO viyprogatos (nombreDes,descripcionproducto, fecha_elaboracion, fecha_caducidad, cantidad) VALUES ('$nombreDes', '$descripcionproducto', '$fecha_elaboracion', '$fecha_caducidad', '$cantidad')";
...
<head>
   ...
   <link rel="stylesheet" href="css/tablascat.css">
   <link rel="stylesheet" href="css/gatito.css">
...
<div class="Caja">
            <div class="formulario">
                <form action="INSERTARvitaminasGATOS.php" method="post">
...
<div class="tablas">
<div class="busqueda">
<form action="BUSCARvitaminasGATOS.php" method="post">
    ...
    <input type="submit" class="boton" value="Buscar">
            ...
            <div class="table-container">
               <h1 class="des" >VITAMINAS Y PREVIOTICOS</h1> 
            <table class="table">
                ...
                <tbody>
                    ...
                    $sql = "SELECT nombreDes, descripcionproducto,fecha_elaboracion, fecha_caducidad, cantidad FROM viyprogatos ORDER BY fecha_caducidad DESC";
                    ...
                    if ($rta) {
                        while ($row = mysqli_fetch_array($rta)) {
                            ...
                            $opciones = "<td><a href='ELIMIARvitaminasgatos.php?nombreDes=" . $row['nombreDes'] . "' class='btn btn-danger'><i class='fas fa-trash'></i> </a>  ";
                            $opciones .= "<a href='ACTUALIZARvitaminasGATOS.php?nombreDes=" . $row['nombreDes'] . "' class='btn btn-danger'><i class='fas fa-edit'></i> </a></td>";
