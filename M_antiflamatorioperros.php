...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT antifflamatoriosperros(nombreDes,descripcionproducto, fecha_elaboracion, fecha_caducidad, cantidad) VALUES ('$nombreDes', '$descripcionproducto', '$fecha_elaboracion', '$fecha_caducidad', '$cantidad')";
    mysqli_query($con, $sql);
}

$sql = "SELECT * FROM antifflamatoriosperros";
...
<div class="Caja">
            <div class="formulario">
                <form action="insertaraAntiflamatorioperros.php" method="post">
...
<label for="nombreDes"><i class="fas fa-search"></i></label>
    ...
    <input type="submit" class="boton" value="Buscar">
            ...
            <h1 class="des" >ANTIFLAMATORIOS</h1>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    $sql = "SELECT nombreDes, descripcionproducto,fecha_elaboracion, fecha_caducidad, cantidad FROM antifflamatoriosperros ORDER BY fecha_caducidad DESC";
                    ...
                    if ($rta) {
                        while ($row = mysqli_fetch_array($rta)) {
                            ...
                            $opciones = "<td><a href='EliminarANTIFLAMATORIOperros.php?nombreDes=" . $row['nombreDes'] . "' class='btn btn-danger'><i class='fas fa-trash'></i> </a>  ";
                            $opciones .= "<a href='actualizarAntiflamatoriosperros.php?nombreDes=" . $row['nombreDes'] . "' class='btn btn-danger'><i class='fas fa-edit'></i> </a></td>";
