...
<div class="Caja">
            <div class="formulario">
                <form action="insertarAnalgesicos.php" method="post">
...
<div class="tablas">
<div class="busqueda">
<form action="buscarANALGESICOSperros.php" method="post">
    ...
    <input type="submit" class="boton" value="Buscar">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    $sql = "SELECT nombreDes, descripcionproducto,fecha_elaboracion, fecha_caducidad, cantidad FROM analgesiosperros ORDER BY fecha_caducidad DESC";
                    ...
                    if ($rta) {
                        while ($row = mysqli_fetch_array($rta)) {
                            ...
                            $opciones = "<td><a href='eliminarANALGESICOperro.php?nombreDes=" . $row['nombreDes'] . "' class='btn btn-danger'><i class='fas fa-trash'></i> </a>  ";
                            $opciones .= "<a href='actualizarAnalgesicosperros.php?nombreDes=" . $row['nombreDes'] . "' class='btn btn-danger'><i class='fas fa-edit'></i> </a></td>";
