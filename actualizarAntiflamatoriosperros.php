...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_actualizar = "UPDATE antifflamatoriosperros SET descripcionproducto=?, fecha_elaboracion=?, fecha_caducidad=?, cantidad=? WHERE nombreDes=?";
    ...
    $sql_select = "SELECT * FROM antifflamatoriosperros WHERE nombreDes=?";
    ...
    if ($resultado && mysqli_num_rows($resultado) > 0) {
        ...
        echo "<form method='post' action='actualizarAntiflamatoriosperros.php'>";
