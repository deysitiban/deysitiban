...
<div class="wrapper">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT nombreDes, descripcionproducto, fecha_elaboracion, fecha_caducidad, cantidad FROM desparasexternosgatos WHERE nombreDes = '$nombreDes_buscar'";
    ...
    <a href="M_externoGATOS.php" class="regresar">Regresar </a>
        </div>
</div>
</body>
</html>
