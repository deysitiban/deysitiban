...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO viyproperros(nombreDes,descripcionproducto, fecha_elaboracion, fecha_caducidad, cantidad) VALUES ('$nombreDes', '$descripcionproducto', '$fecha_elaboracion', '$fecha_caducidad', '$cantidad')";
...
<head>
    ...
    <link rel="stylesheet" href="css/tablaperro.css">
...
<body id="body">
    ...
    <br>
<h4>Menu de perritos</h4>
        <div class="options__menu">

        <a href="M_Pdesexterno.php" class="selected" id="desparacitantes_externos_link">
    <div class="option">
        <i class="fas fa-dog"></i> <!-- Icono de un perrito -->
        <h4>Externos</h4>
    </div>
</a>

            <a href="M_DEintperros.php" class="selected" id="desparacitantes_internos_link">
                <div class="option">
            ...
            <a href="M_antiviotivosperros.php" class="selected" id="antivioticos_link">
                <div class="option">
                <i class="fas fa-dog"></i>
                    <h4>Antibióticos</h4>
                </div>
           ...
           <!-- <a href="M_antiflamatorioperros.php" class="selected" id="antiflamatorio_link">
                <div class="option">
                <i class="fas fa-dog"></i>
            ...
            <a href="M_analgesicos.php" class="selected" id="analgesicos_link">
                <div class="option">
                <i class="fas fa-dog"></i>
                    <h4>Analgésicos</h4>
                </div>
            ...
            <a href="M_vitaminasperros.php" class="selected" id="vitaminas_link">
                <div class="option">
                <i class="fas fa-dog"></i>
...
<div class="Caja">
            <div class="formulario">
                <form action="insertarVitaminas,perros.php" method="post">
                    <h3 class="registro">VITAMINAS</h3>
...
<div class="tablas">
<div class="busqueda">
<form action="buscarVITAMINASperros.php" method="post">
<label for="nombreDes"><i class="fas fa-search"></i></label>
    ...
    <input type="submit" class="boton" value="Buscar">
            ...
            <h1 class="des">VITAMINAS Y PROTECTORES EPATICOS</h1>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    $sql = "SELECT nombreDes, descripcionproducto,fecha_elaboracion, fecha_caducidad, cantidad FROM viyproperros ORDER BY fecha_caducidad DESC";
                    ...
                    if ($rta) {
                        while ($row = mysqli_fetch_array($rta)) {
                            ...
                            $opciones = "<td><a href='eliminarVITAMINASperro.php?nombreDes=" . $row['nombreDes'] . "' class='btn btn-danger'><i class='fas fa-trash'></i> </a>  ";
                            $opciones .= "<a href='actualizarVitaminasperros.php?nombreDes=" . $row['nombreDes'] . "' class='btn btn-danger'><i class='fas fa-edit'></i> </a></td>";
