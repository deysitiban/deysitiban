...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO desparainternosperros(nombreDes,descripcionproducto, fecha_elaboracion, fecha_caducidad, cantidad) VALUES ('$nombreDes', '$descripcionproducto', '$fecha_elaboracion', '$fecha_caducidad', '$cantidad')";
...
<div class="Caja">
            <div class="formulario">
                <form action="inserterinternosperros.php" method="post">
...
<div class="tablas">
<div class="busqueda">
<form action="buscarINTERNOSperros.php" method="post">
<label for="nombreDes"><i class="fas fa-search"></i></label>
    ...
    <input type="submit" class="boton" value="Buscar">
            ...
            <h1 class="des" >DESPARACITANTES INTERNOS</h1>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    $sql = "SELECT nombreDes, descripcionproducto,fecha_elaboracion, fecha_caducidad, cantidad FROM desparainternosperros ORDER BY fecha_caducidad DESC";
                    ...
                    if ($rta) {
                        while ($row = mysqli_fetch_array($rta)) {
                            ...
                            $opciones = "<td><a href='eliminarINTERNOperros.php?nombreDes=" . $row['nombreDes'] . "' class='btn btn-danger'><i class='fas fa-trash'></i> </a>  ";
                            $opciones .= "<a href='actualizarInternosperros.php?nombreDes=" . $row['nombreDes'] . "' class='btn btn-danger'><i class='fas fa-edit'></i> </a></td>";
