...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_actualizar = "UPDATE desparacitantesexternosperros SET descripcionproducto=?, fecha_elaboracion=?, fecha_caducidad=?, cantidad=? WHERE nombreDes=?";
    ...
    $sql_select = "SELECT * FROM desparacitantesexternosperros WHERE nombreDes=?";
    ...
    if ($resultado && mysqli_num_rows($resultado) > 0) {
        ...
        echo "<form method='post' action='actualizarEXTERNOperro.php'>";
