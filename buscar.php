...
<div class="wrapper">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT nombreDes, descripcionproducto, fecha_elaboracion, fecha_caducidad, cantidad FROM desparacitantesexternosperros WHERE nombreDes = '$nombreDes_buscar'";
      ...
      <a href='actualizarEXTERNOperro.php?nombreDes=" . $row['nombreDes'] . "' class='btn btn-info'><i class='fas fa-edit'></i></a></td>";
echo "</tr>";
    ...
    mysqli_close($con);
    ?>
     <a href="M_Pdesexterno.php" class="regresar">Regresar</a>
</div>
