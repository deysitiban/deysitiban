...
<div class="wrapper">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT nombreDes, descripcionproducto, fecha_elaboracion, fecha_caducidad, cantidad FROM desparainternogatos  WHERE nombreDes = '$nombreDes_buscar'";
...
echo "</tr>";
    ...
    mysqli_close($con);
    ?>
     <a href="M_internoGATOS.PHP" class="regresar">Regresar</a>
</div>
